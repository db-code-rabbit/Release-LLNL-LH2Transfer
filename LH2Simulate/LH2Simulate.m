...
function dxdt = LH2dxdt(P,t,x)
    ...
    %
    %% Corrected Nusselt number expressions
    IFmodificationIs =AddedMinorCorrections(); %added by DB
...
%%
    ...
    if (IFmodificationIs ==true) %
        ...
        Nu =VerticalPlates('Churchill',Ra,Pr,P.H-hL2,2*P.R2);           %added by DB 
    else 
...
%
    if (IFmodificationIs ==true)
        ...
        Nu_L_side =VerticalPlates('Churchill',Ra_L_side,Pr_L,hL2,2*P.R2);   % Added by DB
    else
