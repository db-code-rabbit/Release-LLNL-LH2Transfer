...
%% Grid parameters %Ajot de 3 niveaux 
...
%% Solver options
%
LH2Model.tFinal = 60*60;                % [s] final time   60*60
LH2Model.relTol = 1e-5;                 % relative tolerance for ode solver. Doesnt work well with 1e-3
