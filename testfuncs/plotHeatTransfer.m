...
lg =legend('QL_{TOT}','Jtransfer.h','pdV','-QdotLS2', 'QdotWL2',...
    'Jcd.h','Location','northeast'); title(lg,"Heat transfers in liquid phase"); 
ylabel('Heat transfers in LIQUID - ET [Watts]',Fontweight='bold');
...
lg =legend('QV_{TOT}','pdV','Jvalve.h','- QdotVS2', 'QdotWL2',...
    'Jcd.h','Location','southeast'); title(lg,"Heat transfers in gas phase"); 
ylabel('Heat transfers in VAPOR - ET [Watts]',Fontweight='bold');
xlabel('Time in minutes',Fontweight='bold');grid on; axis on;
